...
{
    public class DonerKebabMT : CustomItemGroup
    {
        ...
        public override GameObject Prefab
        {
            get
            {
                return MyDonerMod.Bundle.LoadAsset<GameObject>("Doner Kebab MT");
            }
        }
            ...
            get
            {
                return new List<ItemGroup.ItemSet>
                {
                    new ItemGroup.ItemSet
                    {
                        ...
                        {
                            Refs.ChoppedTomato,
                            GDOUtils.GetCustomGameDataObject<DonerKebabM>().GameDataObject as Item
                        }
                    }
                };
            }
